...
{#if homepage}
    ...
    <PageBloc class="home-page">
        <LayoutBloc>
            ...
            <LayoutBloc>
                <ContentBloc>
                    <LayoutBloc direction="row" grow="0">
                        <button id="work" class="tab-button" class:active={$pageState.work}
                                onclick={()=>showSection('work')}>Work
                        </button>
                        <button id="side_projects" class="tab-button" class:active={$pageState.side_projects}
            ...
            <SectionBlock title="Side Projects" id="side_projects" active={$pageState.side_projects} showHeader={false}>
                <LayoutBloc>
